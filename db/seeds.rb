...
#   puts "Added #{prof.name}"
# end
# puts "Finished with proficiencies. Total: #{Proficiency.count}"
...
# end
# puts "Finished with items. Total: #{Item.count}"
...
#     puts "Added #{st.name} saving throw to #{class_instance.name}'s class."
#   end
...
#     puts "Added #{prof.name} to #{class_instance.name}'s class list."
#   end
...
#     puts "Added #{item.name} to #{class_instance.name}'s starting equipment."
#   end
# end
# puts "Finished with classes. Total: #{ClassList.count}"
...
#     puts "Added #{class_instance.name} class to #{spell_instance.name} spell."
#   end
# end
# puts "Finished with spells. Total: #{Spell.count}"
...
#   puts "Added #{class_list.name} class to #{feat.name} feat."
# end
# puts "Finished with feat. Total: #{Feat.count}"
...
# end
# puts "Finished with languages. Total: #{Language.count}"
...
# puts "Finished with traits. Total: #{Trait.count}"
...
#   end
# end
# puts "Finished with races. Total: #{Race.count}"
