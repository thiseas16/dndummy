...
class RandomCharacterController < ApplicationController
  ...
  def create
    ...
    character = Character.new(
      ...
      current_hp: @responsehash3["Total HP"],
      temp_hp: 0,
      personality_traits: @responsehash2["Background Information"]["Personality Traits"],
      ideals: @responsehash2["Background Information"]["Ideals"],
      bonds: @responsehash2["Background Information"]["Bonds"],
      flaws: @responsehash2["Background Information"]["Flaws"],
      speed: @responsehash["Basic Information"]["Speed"],
      armor_class: @responsehash3["Armor Class"],
      inititiave: @responsehash["Basic Information"]["Initiative"],
      backstory: @responsehash2["Background Information"]["Backstory"],
      # appearance: ,
      age: @responsehash3["Appearance"]["Age"],
      height: @responsehash3["Appearance"]["Height"],
      weight: @responsehash3["Appearance"]["Weight"],
      eyes: @responsehash3["Appearance"]["Eyes"],
      skin: @responsehash3["Appearance"]["Skin"],
      hair: @responsehash3["Appearance"]["Hair"],
